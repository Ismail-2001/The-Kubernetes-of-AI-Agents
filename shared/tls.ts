...
export function getClientCredentials(): grpc.ChannelCredentials {
  ...
  // grpc-js createSsl client-side requires strings on some OpenSSL versions
  return grpc.credentials.createSsl(
    caCert as unknown as Buffer,
    clientCert as unknown as Buffer,
    clientKey as unknown as Buffer
  );
}
